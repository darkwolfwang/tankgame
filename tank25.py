                ...
                if MainGame.my_tank and MainGame.my_tank.live:
                    ...
                    if event.key == pygame.K_LEFT:
                        ...
                        if len(MainGame.myBulletList) < 3:
                            ...
                            #我方坦克发射子弹添加音效
                            music=Music('image/tank_fire.wav')
                            music.play()
...
class Wall():
    def __init__(self,left,top):
        #加载墙壁图片
        self.image=pygame.image.load('image/square0.jpg')
        #获取墙壁的区域
        self.rect=self.image.get_rect()
        #设置位置left,top
        self.rect.left=left
...
class Explode():
    def __init__(self,tank):
        ...
        self.rect=tank.rect
        self.images=[
            pygame.image.load('image/0.gif'),
            pygame.image.load('image/1.gif'),
            pygame.image.load('image/2.gif'),
            pygame.image.load('image/3.gif'),
            pygame.image.load('image/4.gif'),
            pygame.image.load('image/5.gif'),
            pygame.image.load('image/6.gif'),
            pygame.image.load('image/7.gif'),
            pygame.image.load('image/8.gif'),
            pygame.image.load('image/9.gif'),
            pygame.image.load('image/10.gif')
        ]
        self.step=0
